...
const static char DEVICE_NAME[] = "Heartrate-tile";
...
private:
    ...
    virtual void onDisconnectionComplete(const ble::DisconnectionCompleteEvent &event)
    {
        ...
        // 62 = 0x3E --> CONNECTION_FAILED_TO_BE_ESTABLISHED
...
static BufferedSerial serial_port(PC_12, PD_2, 115200);
